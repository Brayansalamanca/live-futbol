...
urlpatterns = [
    ...
    # APIs Ropa
    path('api/guardar-prenda/', login_required(views.api_guardar_prenda), name='api_guardar_prenda'),
    ...
    path('api/eliminar-prenda/<int:prenda_id>/', login_required(views.api_eliminar_prenda), name='api_eliminar_prenda'),
    ...
    # APIs de Balones (Asegúrate de tener estas funciones en views.py)
